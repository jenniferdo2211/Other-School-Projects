...
class ZipUtilityTest {
	...
	void searchByName() {
		...
		Path path1 = Paths.get("C:\\Users\\Thu Trang\\eclipse-workspace\\assignment-07\\Lectures.zip");
	...
	void searchByContent() {
		...
		Path path2 = Paths.get("C:\\Users\\Thu Trang\\eclipse-workspace\\assignment-07\\Lectures.zip");
