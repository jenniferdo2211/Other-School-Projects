...
class JarUtilityTest {
	...
	void searchByName() {
		...
		Path path1 = Paths.get("C:\\Users\\Thu Trang\\eclipse-workspace\\assignment-07\\MyProject.jar");
	...
	void searchByContent() {
		...
		Path path2 = Paths.get("C:\\Users\\Thu Trang\\eclipse-workspace\\assignment-07\\MyProject.jar");
