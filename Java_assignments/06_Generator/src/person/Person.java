...
public abstract class Person implements Comparable<Person>{
	...
	private final Sex _gender;
	private final Date _birthDate;
	private final Locale _nationality;
	
	public Person(String pesel, String sname, String fname, Sex gender, Date birthDate, Locale nation) {
		PESEL = pesel;
		_surname = sname;
		_firstName = fname;
		_gender = gender;
